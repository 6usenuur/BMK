...
# 8- Aşağıdaki verileri liste içerisinde saklayınız (Lisste içinde liste mümkündür.).

    # öğrenci1: Yiğit Bİlgi 2010 [70, 80, 90]
...
cinarin_ortalamasi=(ogrenci3[3][0] + ogrenci3[3][1] + ogrenci3[3][2])/3

print(yigitin_ortalamasi)
print(adanin_ortalamasi)
print(cinarin_ortalamasi)
